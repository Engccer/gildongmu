...
- **17개 도구**: 장소2(검색·주소)·내주변5(소아진료·아이놀곳·둘러보기·지하철·무장애관광지)·좌표4(버스·따릉이·공기질·보행인프라 `get_walk_infrastructure` — 무키라 게이트 없음, 서비스 계층만 호출)·역명2·길찾기3(자동차·대중교통·도보 `get_walk_route`)·웹검색1(`search_web` Perplexity). 각 게이트. `get_bus_route`는 V1 제외.

...
enum TransitGuideTextRenderer {
    ...
    private static func part(_ p: TransitTextPart) -> String {
        ...
        case "waitContextBus": return appLocalized("transitGuide.waitContextBus", arguments: args)
        case "waitContextWalk": return appLocalized("transitGuide.waitContextWalk", arguments: args)
        case "waitContextWalkBus": return appLocalized("transitGuide.waitContextWalkBus", arguments: args)
        case "boardingContext": return appLocalized("transitGuide.boardingContext", arguments: args)
        case "boardingContextBus": return appLocalized("transitGuide.boardingContextBus", arguments: args)
        case "context": return appLocalized("transitGuide.context", arguments: args)
        case "contextBus": return appLocalized("transitGuide.contextBus", arguments: args)
        case "remainingCount": return appLocalized("transitGuide.remainingCount", arguments: args)
        case "remainingCountJoin": return appLocalized("transitGuide.remainingCountJoin", arguments: args)
        case "stopsAway": return appLocalized("transitGuide.stopsAway", arguments: args)
        case "stopsAwayOnly": return appLocalized("transitGuide.stopsAwayOnly", arguments: args)
        case "busEtaMinSec": return appLocalized("transitGuide.busEtaMinSec", arguments: args)
        case "busEtaMin": return appLocalized("transitGuide.busEtaMin", arguments: args)
        case "busEtaSec": return appLocalized("transitGuide.busEtaSec", arguments: args)
        case "busSoon": return appLocalized("transitGuide.busSoon", arguments: args)
        case "busNotDeparted": return appLocalized("transitGuide.busNotDeparted", arguments: args)
        case "busTurning": return appLocalized("transitGuide.busTurning", arguments: args)
        ...
        case "arrivedAtBoardStopBus": return appLocalized("transitGuide.arrivedAtBoardStopBus", arguments: args)
        case "arrivingAtBoardStop": return appLocalized("transitGuide.arrivingAtBoardStop", arguments: args)
        case "arrivingAtBoardStopBus": return appLocalized("transitGuide.arrivingAtBoardStopBus", arguments: args)
        case "boarded": return appLocalized("transitGuide.boarded", arguments: args)
        case "boardedAlight": return appLocalized("transitGuide.boardedAlight", arguments: args)

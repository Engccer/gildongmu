...
| `TMAP_APP_KEY` | `hasTmapKey`(도보 노출 게이트는 `hasWalkRouteKey`) | SK open API 앱 `gildongmu`(2026-07-21 발급, T아이디). **보행자 경로 폴백**(2026-07-29 카카오 기본 전환) + 자동차·POI 동일 키 커버. 일 1,000건 무료, IPS "Any IP allowed" 유지(IP 제한 금지 — Vercel 가변 egress) |

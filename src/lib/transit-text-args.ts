...
export const TRANSIT_TEXT_ARG_NAMES: Record<string, readonly string[]> = {
  ...
  waitContextBus: ["stop", "line"],
  waitContextWalk: ["minutes", "stop", "line"],
  waitContextWalkBus: ["minutes", "stop", "line"],
  boardingContext: ["stop", "line"],
  boardingContextBus: ["stop", "line"],
  context: ["line", "stop"],
  contextBus: ["line", "stop"],
  remainingCount: ["count"],
  remainingCountJoin: ["count"],
  stopsAway: ["count"],
  stopsAwayOnly: ["count"],
  busEtaMinSec: ["minutes", "seconds"],
  busEtaMin: ["minutes"],
  busEtaSec: ["seconds"],
  busSoon: [],
  busNotDeparted: [],
  ...
  arrivedAtBoardStopBus: ["line"],
  arrivingAtBoardStop: ["line"],
  arrivingAtBoardStopBus: ["line"],
  boarded: [],
  boardedAlight: ["stop"],

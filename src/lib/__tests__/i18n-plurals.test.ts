...
describe("수량 문구 복수형(A29)", () => {
  ...
  const EN_GOLDEN_ONE: Record<string, string> = {
    ...
    "transitGuide.startedAt": "Starting transit guidance to x. 1 ride segment.",
    "subwayArrival.departedStopsBack": "Departed the station 1 stop back.",
    "subwayArrival.stopsAway": "1 stop away, at x.",
    "subwayArrival.stopsJoin": "1 stop away",
    "transitGuide.remainingCount": "1 stop remaining.",
    "transitGuide.remainingCountJoin": "1 stop remaining",
    "transitGuide.stopsAway": "1 stop away",
    "transitGuide.stopsAwayOnly": "1 stop away.",

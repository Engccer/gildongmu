...
const mockFind = vi.mocked(findAirQualityNear);

function makeRequest(query: string) {
  return new NextRequest(`http://x/api/air-quality/nearby${query}`);
}

describe("GET /api/air-quality/nearby (커버리지 마커 계약)", () => {
  beforeEach(() => {

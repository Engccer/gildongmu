...
| iOS | **1.11 `IN_REVIEW`**(빌드 18, 아카이브 커밋 `f312a39`, 제출 2026-08-22 07:11 KST) · 스토어 최신은 1.10 `READY_FOR_SALE`(빌드 17) · 1.7~1.9도 `READY_FOR_SALE`. 아카이브 뒤 iOS 변경은 `docs/BACKLOG.md` G5 |

...
축 요약(2026-08-16 기준): **가장 큰 병목은 판정**이다 — 코드가 끝나고 위원장 실사용·실기기를 기다리는 항목이 도보 14·자동차/대중교통 4계열이고, 그중 자동차·대중교통 판정이 G3 봉인 해제의 **유일한** 선행 조건이다. 결함은 2건(A16 급행 3층 침묵 · A1 동결)으로 줄었고(A7·A11·A13은 2026-08-16 종결), 갭은 2건(B4·B6)이다.

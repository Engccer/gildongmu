...
| iOS | **1.8 `WAITING_FOR_REVIEW`**(빌드 15, 아카이브 커밋 `1cad836`, 제출 2026-08-17 20:10 KST) · 1.7까지 전부 `READY_FOR_SALE`(1.7 = 빌드 13, 도보 실시간 안내 정식 출시) |
...
| 기능 | 비고 |
|---|---|
| 보행 인프라 | 음향신호기(서울 seed) + 횡단보도·점자블록(전국 OSM seed 79,574 노드, 연 1회 갱신) |

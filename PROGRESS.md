...
도보 도착 종료 화면에 걸음·칼로리 요약 한 줄이 들어갔다(iOS, 빌드 구성 무관 — 2026-08-17 — CMPedometer 실측 + 활동 칼로리 추정). **1.8로 출시됨(2026-08-18 `READY_FOR_SALE`), 1.9에서 문장형·음식 비유·체중 안내로 개정.** ⏳ 실기기 판정(`docs/BACKLOG.md` §2 "건강 요약", 대본 `docs/FIELD-TEST.md` §3).

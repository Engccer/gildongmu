...
| iOS | **1.15 `READY_FOR_SALE`**(빌드 23, 아카이브 커밋 `ff6e1897`, 제출 2026-09-03 04:39 KST · 출시 확인 2026-09-10 `asc-submit.mjs --check`). 스토어 최신이 1.15다. ⚠ 1.15 아카이브 뒤 iOS 커밋은 스토어에 없다 — `git log ff6e1897..HEAD -- ios/` |

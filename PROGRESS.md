...
| 장소 영업시간(E24) | Google Places(New) 한 줄, **iOS 실험판 전용**(웹 미러 없음). 어떤 실패도 침묵(`{hours:null}`), VoiceOver만 읽는다(약관 TTS 금지) (⏳ 정식판 승격 판정) |
...
| 도보 경로 대안(M3+E10ⓑ) | 추천·최단 2행 제시(iOS Release 포함, 웹 조회 화면 2026-08-23), 안내 중 전환·이탈 시 자동 재조회(2026-09-02 수락제 폐기)는 iOS Experimental (⏳ 실보행 판정, 웹 전환은 B9 ② 대기) |

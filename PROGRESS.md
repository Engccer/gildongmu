...
도보 도착 종료 화면에 걸음·칼로리 요약 한 줄이 들어갔다(iOS, 빌드 구성 무관 — 스토어 1.7에는 없고 1.8 대상, 2026-08-17 — CMPedometer 실측 + 활동 칼로리 추정). ⏳ 실기기 판정(`docs/BACKLOG.md` §2 "건강 요약", 대본 `docs/FIELD-TEST.md` §3), 1.8 미제출.

...
| 진행 상태 진동 3종(E30) | **iOS 실험판 설정 스위치**(2026-09-13, 기본 꺼짐 = 정식판과 같은 동작) — 켜면 가까워짐·정지·신뢰 불가에 진동이 더해진다(기존 10종은 스위치 무관). 화면 잠금 억제는 세션 원래 동작. ⏳ 위원장 손 판정(§2 E30) + 시청각장애 당사자 판정 경로(§8), 정식 포함 = 2.0 |

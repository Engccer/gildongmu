...
| iOS | **1.16 `WAITING_FOR_REVIEW`**(빌드 24, 아카이브 커밋 `b6a7e5c2`, 제출 2026-09-11 14:11 KST). 스토어 최신은 **1.15**(빌드 23, 아카이브 `ff6e1897`, 출시 2026-09-10). ⚠ 1.16 아카이브 뒤 iOS 커밋은 스토어에 없다 — `git log b6a7e5c2..HEAD -- ios/`. ⚠ 아카이브 커밋은 **로컬 main에만 있다**(동결) |
...
안내 시트의 VoiceOver 착지 대상은 **상태 문장 행 하나**다(E38, 2026-09-12 — iOS·웹 동형). ⏳ 실승차 판정(`controlFocus target=status landed=`).

안내 시트 상태 문장은 **한 조립기가 만드는 문장형**이고 전이 통지는 그 문장에 없는 것만 말한다(E39·E41, 2026-09-12 — iOS·웹 동형). 세 수단 시작 통지는 목적지를 말한다(E40). ⏳ 실승차·실보행 판정(§2 E39·E40·E41 행).

...
축 요약(2026-08-16 재편 기준): **가장 큰 병목은 판정**이다 — 코드가 끝나고 위원장 실사용·실기기를 기다리는 항목이 도보 13·자동차/대중교통 4계열이고, 그중 자동차·대중교통 판정이 G3 봉인 해제의 **유일한** 선행 조건이다. 결함은 6건(A16 급행 3층 침묵 · A11 넓은 부지 도착 · A13 재시작 인자 유실 · A7 캐시 좌표 · A15 공지 표시 경합 · A1 동결), 갭은 2건(B4·B6)이다.

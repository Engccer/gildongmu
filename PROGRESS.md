...
| boarding 국면 선언 버튼(N3 재설계) | iOS 실험판 + 웹 미러(2026-09-11) — 차량을 고른 직후엔 버튼이 없고 **승차 정류소 도착 관측**이 riding 승격을 한다. 관측이 끝난 뒤(`signalLost`·`upstreamFailed`)에만 [도착 정보 없이 탑승 진행]이 서고, 대기 국면 버튼은 "이미 탔습니다". ⏳ 실승차 판정(§2 N3 행 ⑤~⑧) |

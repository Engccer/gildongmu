...
도보 도착 종료 화면에 걸음·칼로리 요약 한 줄이 들어갔다(iOS 정식·실험, 2026-08-17 — CMPedometer 실측 + 활동 칼로리 추정). ⏳ 실기기 판정(행 존재·VO 순서·조회 지연,  §3), 1.8 미제출.

축 요약(2026-08-17 기준): **가장 큰 병목은 판정**이다 — 코드가 끝나고 위원장 실사용·실기기를 기다리는 항목이 §2 표(도보·자동차·대중교통)에 쌓여 있고, 그중 자동차·대중교통 판정이 G3 봉인 해제의 **유일한** 선행 조건이다. 대중교통에서 사람 없이 할 수 있는 것은 남지 않았다(실호출 게이트 5축 2026-08-16 종결). 결함은 A16(**L2·L3 종결, L1만 잔여** — 급행 정차역 데이터 선행)과 A1(동결) 둘만 남았고(A7·A11·A13은 2026-08-16, A18은 2026-08-17 종결), 갭은 B4·B6·B7이다. ⚠ **건수를 여기 적지 않는다** — 표가 정본이고 수치는 사흘에 세 번 낡는다.

...
| `status-prose`(웨이브 2) | E41(착지·통지 중복, 위원장 문안 판정) + E40(시작 통지에 목적지, 3수단) + [E39](../../BACKLOG.md#e39-대중교통-안내-시트-상태-문장을-문장형으로--서울버스-승차-대기부터--2026-09-12-실승차-피드백-e37-자매) 상태 문장 문장형 | `opus` | 구조 확정(A26 클라이언트 조립), 문안은 위원장 TextEdit 왕복 |

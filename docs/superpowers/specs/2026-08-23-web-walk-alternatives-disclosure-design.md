...
> ⚠ 2026-09-23 E42: 두 줄이 최단·계단 회피(없으면 큰길)로 바뀌고 계단 회피 토글이 없어졌으며, 안내 시작 버튼은 줄 안으로 들어갔다(아래 "토글·안내 시작 버튼 자리 불변"은 무효). 정본 `2026-09-23-walk-two-lines-kakao-design.md` §3.

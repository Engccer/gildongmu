...
- **프로덕션 실측**(배포 `705c46c` 직후, 2026-08-31): places 98.3% · around 94.0% · kids 100% · scene 96.0% → **전체 카드 97.0%(1,833/1,890) · 고유 경로 88.4%(222/251) · 요청 실패 0 → PASS**. 재실행은 같은 명령(base 생략).

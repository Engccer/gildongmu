...
- 2026-08-28 위원장 판정으로 아래 항목은 W2 spec이 정본이다 — **2026-08-29부터 `2026-08-29-webmcp-wave2-design.md`**(상시 집합 7개, 사례 ① 한정; 오전판 `2026-08-28-…`은 폐기). W2는 이 문서의 도구 10개 중 `focus_item`·안내 3종·보행 인프라·`open_directions`를 **삭제**하고 §5.1의 홈↔길찾기 전환 등록을 루트 상시 등록으로 바꾼다. 여기 남기던 후보 목록은 그 spec §1로 옮겼다.

...
| `transit-guide-diag-2026-08-16.log` | 대중교통 계측 전량(회전 없음, 8행). **단일 세션 2026-08-14 KST 09:57~10:34** — 대기 폴 3회는 전부 건강(`ok(3) candidates=1 vehIdless=0 terminates=0 directionUncertain=false reason=-`)이라 #4 원인 6후보 중 **대기 후보 필터 계열은 무고**. 승차 35분 내내 `signal=notYetVisible`(추적 신호 미부착 → 사다리 통지 0), `legIndex=0`에서 끝나 `legAdvanced`·`arrived` 0건. `boardingReset` 2회는 자동 전이가 아니라 사용자의 "탑승 변경"이고 각각 8~9초 뒤 재탑승했다 | BACKLOG F-a 라운드1 재판정 ③(대기 고정 #4 원인 판별)·⑨ |

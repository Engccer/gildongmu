...
| **TAGO 버스 패밀리** (도착 15098530·정류소근접 15098534·노선 15098529) | 시내버스 | **검증 완료 (2026-06-14, 3-0)** — 국토부 data.go.kr, 무료·ServiceKey·개발 일 10,000건(노선 한도만 재확인). WGS84 좌표+한글 낭독 정합. **최대 공백** | **높음** — "가까운 정류장→버스 도착 텍스트 안내"가 지도 없이 완결. 실시간이라 딥링크 대체 불가 |
